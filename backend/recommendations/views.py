...
class WatchlistViewSet(viewsets.ModelViewSet):
    ...
    def mark_watched(self, request, pk=None):
        ...
        # Create a matching interaction for stats/recommendations
        UserMovieInteraction.objects.get_or_create(
            user=request.user,
            movie_tmdb_id=item.movie_tmdb_id,
            interaction_type=UserMovieInteraction.InteractionType.WATCHED,
            defaults={"movie_title": item.movie_title}
        )
